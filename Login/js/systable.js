...
SYSTableSorter.prototype = {
	...
	pageTableMethod: function(html, curPage, pageTotal, pageSize, total) {
		...
		let childFlag=pagination.childNodes.length;
		if(childFlag>0){
			let childs=pagination.childNodes;
			console.log(childs);

			for(let i=0;i<childs.length;i++){
				pagination.removeChild(childs[i])	
			}            
		}
        console.log(pagination.childNodes.length);
